...
function WPIProvider({ authorization, token, tenantId, ...rest }: OAuthUserConfig<WPIProfile> & { tenantId: string, profile: NonNullable<OAuthUserConfig<WPIProfile>['profile']> }): OAuthConfig<WPIProfile> {
    return {
        id: 'wpi',
        name: 'WPI Login',
        type: 'oauth',
