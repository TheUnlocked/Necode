...
function createTestDomActivityDescription(networked: boolean) {
    const [activityPage, configPage] = createTestActivityPages({ networked });
...
export const testDomActivityDescription = createTestDomActivityDescription(false);
export const testDomActivityNetworkedDescription = createTestDomActivityDescription(true);